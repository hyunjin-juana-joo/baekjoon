package com.baekjoon.test.level2.problem2884;
...
public class Main {
    ...
    public static void main(String args[]){
        ...
        try {
            ...
            long diffTime = 1000 * 60 * 45;
            long alarm = parseTime.getTime() - diffTime;

            System.out.println(simpleDateFormat.format(alarm));
